...
:--------:|:-------:|:------:|:------:|:--------:
1 | 2 | 3 | 4 | 5
Овощи| 70 000 | 120 000 | - 50 000 | - 42
Фрукты| 50 000 | 40 000 | + 10 000 | + 25
**Доходы от реализации** | **120 000** | **160 000** | **- 40 000** | **- 25**

В этой таблице мы расшифровали строку "Доходы от реализации" из Таблицы 1. Из Таблицы 2 мы видим, что снижение доходов от реализации произошло за счет снижения доходов от продажи овощей, в то время как доходы от продажи фруктов увеличились. Теперь посмотрим как именно изменились доходы от продажи по каждой группе овощей.
...
:--------:|:-------:|:------:|:------:|:--------:
1 | 2 | 3 | 4 | 5
Помидоры| 10 000 | 30 000 | - 20 000 | - 67
Огурцы| 20 000 | 50 000 | - 30 000 | - 60
Картофель| 40 000 | 40 000 | 0 | 0
**Доходы от реализации овощей** | **70 000** | **120 000** | **- 50 000** | **- 42**

Из таблицы 3 делаем вывод, что доходы от продажи картофеля остались на прежнем уровне, а доходы от продажи помидоров и огурцов упали. Причем в абсолютном выражении большее снижение произошло по товарной группе "Огурцы", а в относительном - по группе "Помидоры". Теперь посмотрим, как изменилась структура покупателей помидоров и огурцов.

***Таблица 4***

Покупатели помидоров | 2021, руб.| 2020, руб. | Абсолютное отклонение, руб.| Относительное отклонение, %
:--------:|:-------:|:------:|:------:|:--------:
1 | 2 | 3 | 4 | 5
Катюша| 0 | 5 000 | - 5 000 | - 100
Ромашка| 3 000 | 15 000 | - 12 000 | - 80
Сказка| 7 000 | 10 000 | - 3 000 | - 30
**Доходы от реализации помидоров** | **10 000** | **30 000** | **- 20 000** | **- 67**

***Таблица 5***

Покупатели огурцов | 2021, руб.| 2020, руб. | Абсолютное отклонение, руб.| Относительное отклонение, %
:--------:|:-------:|:------:|:------:|:--------:
1 | 2 | 3 | 4 | 5
...
**Доходы от реализации огурцов** | **20 000** | **50 000** | **- 30 000** | **- 60**
