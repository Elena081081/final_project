...
На выходе сравним, насколько удалось оптимизировать проведение факторного анализа посредством каждого из инструмента, и какой из них для решения поставленной задачи наиболее эффективный.
